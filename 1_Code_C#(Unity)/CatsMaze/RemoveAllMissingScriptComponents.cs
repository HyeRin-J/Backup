...
public class RemoveAllMissingScriptComponents : Editor
{
    [MenuItem("Edit/Remove All Missing Script Components")]
    private static void RemoveAllMissingScriptComponent()
    {
